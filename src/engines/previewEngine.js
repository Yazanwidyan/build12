...
const TOPIC_DATA = {
  pets: {
    ...
    testimonials: [
      { name: 'Sarah M.', text: 'Adopted Buddy last year — best decision we ever made!' },
      { name: 'Tom K.',   text: 'The training tips completely transformed our dog.' },
      { name: 'Lisa P.',  text: 'Our rescue cat Luna is the sweetest thing ever.' },
    ],
    contact: { heading: 'Want to Adopt?', subtext: 'Reach out and we\'ll match you with your perfect companion.' },
  },
  space: {
    emoji: '🚀',
    about: {
    ...
    testimonials: [
      { name: 'Alex R.',  text: 'Finally understand black holes thanks to this site!' },
      { name: 'Priya S.', text: 'The star guide made my camping trip magical.' },
      { name: 'Jordan L.', text: 'Best space resource for curious minds.' },
    ],
    contact: { heading: 'Join the Mission', subtext: 'Connect with our community of space explorers and stargazers.' },
  },
  music: {
    emoji: '🎵',
    about: {
    ...
    testimonials: [
      { name: 'Maya T.',   text: 'Learned guitar in 3 months with these lessons!' },
      { name: 'Caleb D.',  text: 'The playlists are absolutely perfect for studying.' },
      { name: 'Nina K.',   text: 'Open mic night changed my life. Incredible community.' },
    ],
    contact: { heading: 'Get In Touch', subtext: 'Questions about lessons, performances, or playlists? We\'d love to hear from you.' },
  },
  sports: {
    emoji: '⚽',
    about: {
    ...
    testimonials: [
      { name: 'Diego M.',  text: 'Training tips helped me score 12 goals this season!' },
      { name: 'Emma W.',   text: 'Best sports community I\'ve ever been part of.' },
      { name: 'Kyle B.',   text: 'The schedule feature keeps our whole team organised.' },
    ],
    contact: { heading: 'Join the Club', subtext: 'Ready to train, compete, and win? Get in touch with our coaching team.' },
  },
  gaming: {
    emoji: '🎮',
    about: {
    ...
    testimonials: [
      { name: 'Zach P.',  text: 'The strategy guides helped me finally beat the final boss!' },
      { name: 'Ava L.',   text: 'Best game reviews on the internet — always honest.' },
      { name: 'Marco S.', text: 'Top scores leaderboard keeps me coming back every day.' },
    ],
    contact: { heading: 'Level Up Together', subtext: 'Got a game tip or want to submit your top score? Reach out to the hub.' },
  },
  art: {
    emoji: '🎨',
    about: {
    ...
    testimonials: [
      { name: 'Isla R.',  text: 'The watercolor tutorials took my art to the next level.' },
      { name: 'Omar N.',  text: 'Submitting to the showcase was life-changing for my career.' },
      { name: 'Jess T.',  text: 'This is where I go every day for creative inspiration.' },
    ],
    contact: { heading: 'Let\'s Create Together', subtext: 'Share your art, request a tutorial, or just say hello to our artist community.' },
  },
  science: {
    emoji: '🔬',
    about: {
    ...
    testimonials: [
      { name: 'Finn O.',  text: 'The home experiments section is brilliant for my kids.' },
      { name: 'Rosa C.',  text: 'Finally a science site that explains things clearly!' },
      { name: 'Sam H.',   text: 'Research hub helped me with my school project. 10/10.' },
    ],
    contact: { heading: 'Ask the Lab', subtext: 'Got a science question or experiment idea? Our team would love to hear it.' },
  },
  food: {
    emoji: '🍕',
    about: {
    ...
    testimonials: [
      { name: 'Claire B.', text: 'Made the ramen recipe for my whole family — they loved it!' },
      { name: 'Yusuf A.',  text: 'Best spot recommendations in the city. Always accurate.' },
      { name: 'Mia J.',    text: 'My cooking improved so much since I found this kitchen.' },
    ],
    contact: { heading: 'Got a Recipe?', subtext: 'Share your favourite dish or ask us anything about cooking and ingredients.' },
  },
  travel: {
    emoji: '✈️',
    about: {
    ...
    testimonials: [
      { name: 'Ana S.',   text: 'The Tokyo guide made our trip absolutely perfect.' },
      { name: 'Ben F.',   text: 'Every hotel recommendation was spot on. No duds!' },
      { name: 'Lara M.',  text: 'Photo diaries inspire me to travel somewhere new every month.' },
    ],
    contact: { heading: 'Plan Your Next Trip', subtext: 'Tell us your dream destination and we\'ll help you make it happen.' },
  },
  fashion: {
    emoji: '👗',
    about: {
    ...
    testimonials: [
      { name: 'Cleo V.',  text: 'The DIY guides helped me create my signature look!' },
      { name: 'Jake R.',  text: 'Shop the Look feature saves me so much time.' },
      { name: 'Nadia T.', text: 'Best trend forecasting I\'ve found anywhere online.' },
    ],
    contact: { heading: 'Style Questions?', subtext: 'Ask about trends, DIY tips, or submit your own look to be featured.' },
  },
}
...
function getTopicData(topic) {
  ...
  return {
    ...
    testimonials: [
      { name: 'Alex R.',  text: 'This site completely changed how I think about the topic.' },
      { name: 'Sam T.',   text: 'Highly recommended to everyone I know. Amazing resource.' },
      { name: 'Jamie L.', text: 'I come back every week. Best content anywhere online.' },
    ],
    contact: { heading: 'Get In Touch', subtext: 'We\'d love to hear from you. Drop us a message anytime.' },
  }
}
...
export function generateWebsiteHTML(website, reactDemo = null) {
  ...
  const header       = sections.header       || { built: false, styled: false, content: {} }
  ...
  const footer       = sections.footer       || { built: false, styled: false, content: {} }
  ...
  const headerHTML = !header.built
    ...
    : `<header style="background:#f8fafc;border-bottom:1.5px solid #e5e7eb;padding:0 2rem;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:10;height:62px;animation:fadeIn 0.4s ease-out;">
        ...
        <nav style="display:flex;gap:1.5rem;">
          ${(header.content?.navLinks || ['Home', 'About', 'Contact']).map(link =>
  ...
  const heroBtn = (hero.content?.buttonText || heroBtnText)
    ? buildHeroButton(heroBtnText, buttonColor, btnRadius, demo, name, website.hasInteractivity, hero.styled)
    : ''
  ...
  const heroHTML = !hero.built
    ...
    : `<section style="position:relative;background:#f9fafb;height:320px;overflow:hidden;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:1rem;padding:0 2rem;border-bottom:1px solid #e5e7eb;animation:fadeIn 0.4s ease-out;">
...
// ── Hero button ───────────────────────────────────────────────────────────────
function buildHeroButton(text, btnColor, btnRadius, demo, siteName, hasInteractivity, heroStyled) {
