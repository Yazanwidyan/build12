        ...
        steps: [
          {
            ...
            tekiMessages: [
              ...
              "This isn't a website yet — it's just a blank page!",
              "Every website is made of building blocks called elements.",
              "The HEADER sits at the top — it shows your site name and navigation links.",
              "The HERO is the big section visitors see first — your headline and call to action.",
              "The FOOTER lives at the bottom — copyright info and extra links.",
              "Right now? All three are missing. That's where YOU come in! 🔨",
              "We'll build them one by one — and by the end, you'll have a real live website!",
            ],
            showBlueprint: true,
